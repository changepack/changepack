...
class Faraday::Adapter::Test < ::Faraday::Adapter
  ...
  #
  # source://faraday//lib/faraday/adapter/test.rb#230
  def initialize(app, stubs = T.unsafe(nil), &block); end

  # @param env [Faraday::Env]
  #
  # source://faraday//lib/faraday/adapter/test.rb#241
  def call(env); end

  # @yield [stubs]
  #
  # source://faraday//lib/faraday/adapter/test.rb#236
  def configure; end
...
# Stub request
#
# source://faraday//lib/faraday/adapter/test.rb#171
class Faraday::Adapter::Test::Stub < ::Struct
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/test.rb#210
  def headers_match?(request_headers); end

  # @param env [Faraday::Env]
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/test.rb#172
  def matches?(env); end
...
class Faraday::Adapter::Test::Stubs
  ...
  # source://faraday//lib/faraday/adapter/test.rb#109
  ...
  #
  # source://faraday//lib/faraday/adapter/test.rb#130
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/test.rb#160
