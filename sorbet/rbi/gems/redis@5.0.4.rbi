...
class Redis::Client < ::RedisClient
  ...
  # source://redis//lib/redis/client.rb#104
  def multi; end
  ...
  # source://redis//lib/redis/client.rb#98
  def pipelined; end
  ...
  # source://redis//lib/redis/client.rb#140
  def ensure_connected(retryable: T.unsafe(nil)); end

  # @raise [redis_error]
  #
  # source://redis//lib/redis/client.rb#125
  def translate_error!(error); end

  # source://redis//lib/redis/client.rb#130
